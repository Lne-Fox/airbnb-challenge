...
function Header({ placeholder }) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      {/*-------------- Left --------------*/}
      <div onClick={() => router.push('/')} className='relative flex items-center h-10 cursor-pointer transition duration-150 hover:grayscale '>
        <Image
      ...
      <div className='flex items-center space-x-4 justify-end text-gray-500 cursor-pointer'>
        ...
        <GlobeAltIcon className='h-6 hover:text-red-400 hover:animate-spin' />
        ...
        <div className="flex flex-col col-span-3 mx-auto">
          ...
          <div className='flex items-center border-b mb-4'>
            ...
            <input value={noOfGuests} onChange={e => setNoOfGuests(e.target.value)}
              min={1} type='number' className='w-12 pl-2 text-lg outline-none text-red-400' />
          </div>
          <div className='flex '>
